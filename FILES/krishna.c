...
void Beverages()
{
    ...
    printf("----------------------------------------------------------------------------------------------------------------------------------------------------------------------------");
    printf("\n\n\n\t\tStandard tea (150 ml) in disposable cups of 170 ml capacity                       Rs.5");
    printf("\n\n\n\t\tTea (with tea bag) (150 ml) in disposable cups of 170 ml capacity                 Rs.10");
    printf("\n\n\n\t\tCoffee using instant Coffee powder (150 ml) in disposable cups of 170 ml capacity Rs.10");
    printf("\n\n\n\t\tEnter 2 to go back to previous menu or Enter 0 to go back to main menu");
    printf("\n\n\n\t\tENTER YOUR CHOICE: ");
    int v;
    scanf("%d", &v);
...
void Breakfast()
{
    ...
    printf("----------------------------------------------------------------------------------------------------------------------------------------------------------------------------");
    printf("\n\n\n\t\tVeg Break fast (Cutlet) =Bread Slice (2nos)50 gms,Veg cutlet (2nos) 100 gms,Butter in blister pack 8gms,Tomato ketchup in sachets(1nos)12gms,Casserole 1,Napkin 1,Disposable spoon1.        Rs.35");
    printf("\n\n\n\t\tVeg Break fast (Idli & Vada) =Idli (2nos) 100gms,Vada (2nos) 60 gms,Chutney in disposable cup 50 gms,Casserole 1,Napkin 1, Disposable spoon 1.                                               Rs.35");
    printf("\n\n\n\t\tVeg Break fast (Upma & Vada) = Upma 100gms,Vada (2nos) 60 gms,,Chutney in disposable cup 50 gms,Casserole 1,Napkin 1, Disposable spoon 1.                                                    Rs.35");
    printf("\n\n\n\t\tEnter 2 to go back to previous menu or Enter 0 to go back to main menu");
    printf("\n\n\n\t\tENTER YOUR CHOICE: ");
    int v;
    scanf("%d", &v);
...
void Meals()
{
    ...
    printf("----------------------------------------------------------------------------------------------------------------------------------------------------------------------------");
    printf("\n\n\n\t\t Veg Meal (Standard Casserole)= Rice Plain 150 gms,2Parathas/4Chapatis in wrappers 100gms,Dal/sambar(Thick) 150 gms,Mix Veg (Seasonal) 100gms, Curd 80 gms,Pickly in sachet 12 gms,Casserole 1,Napkin 1,Disposable Spoon 1.                                                         Rs.70");
    printf("\n\n\n\t\tNon-Veg Meal Standard Casserole (Egg Curry with Rice) =Rice Plain 150 gms,2Parathas/4Chapatis in wrappers 100gms,Dal/sambar(Thick) 150 gms,Two Egg Curry 150 gms,Curd 80 gms,Pickly in sachet 12 gms,Casserole 1,Napkin 1,Disposable Spoon 1.                                       Rs.80");
    printf("\n\n\n\t\tNon-Veg Meal Standard Casserole (Chicken Curry with Rice) =Rice Plain 150 gms,2Parathas/4Chapatis in wrappers 100gms,Dal/sambar(Thick) 150 gms,Chicken Curry (60 gms boneless chicken & Gravy 90 gms),Curd 80 gms,Pickly in sachet 12 gms,Casserole 1,Napkin 1,Disposable Spoon 1. Rs.120");
    printf("\n\n\n\t\tEnter 2 to go back to previous menu or Enter 0 to go back to main menu");
    printf("\n\n\n\t\tENTER YOUR CHOICE: ");
    int v;
    scanf("%d", &v);
...
void AlaCarteItems()
{
    ...
    printf("----------------------------------------------------------------------------------------------------------------------------------------------------------------------------");
    printf("\n\n\n\t\tSamosa- 2X50 gms Tomato Sauce Sachet- 10-15gms Packed in butter paper envelop                                                          Rs.20");
    printf("\n\n\n\t\tKachori- 2X50 gms Tomato Sauce Sachet- 10-15gms Packed in butter paper envelop                                                         Rs.20");
    printf("\n\n\n\t\tPacked Milk of approved brand -200 ml Sugar Sachet- 5 gms Milk may be served cold, room temperature or hot as desired by the passenger Rs.35");
   printf("\n\n\n\t\tEnter 2 to go back to previous menu or Enter 0 to go back to main menu");
    printf("\n\n\n\t\tENTER YOUR CHOICE: ");
    int v;
    scanf("%d", &v);
